...
>   commands stay thin, services hold orchestration, db layer is the
>   only SQL site
...
**Sandbox note**: `gh` commands (`gh pr comment`, `gh pr review`) and
`git push` require sandbox bypass for TLS certificate validation. Use
